...
// Convém colocar valores que vão ser usados de forma repetida em variáveis ou constantes.
...
export function ToDo() {
  ...
  function fetchPessoas() {
    fetch(API_URL + "/getPessoas", {
      ...
      .then((parsedResponse) => {
        // Como ele só chega aqui se tiver sucesso basta atualizar a variável Pessoas

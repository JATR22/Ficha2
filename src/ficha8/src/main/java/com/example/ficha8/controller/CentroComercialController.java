package com.example.ficha8.controller;
...
import com.example.ficha8.service.CentroComercialService;
...
public class CentroComercialController {
	...
	public List<CentroComercial> gettAllCentroComercial(){
		return centroComercialService.getAllCentroComercial();
	}
	
	@GetMapping("/getCentroComercialById/{id}")
	public Optional<CentroComercial> getCentroComercialById(@PathVariable Long id){
